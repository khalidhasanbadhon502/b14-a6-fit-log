  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white p-4 sm:p-6 md:p-12">
      <div className="max-w-6xl mx-auto">
        ...
        <h1 className="text-2xl sm:text-3xl font-black uppercase mb-1">My Plan</h1>
        <p className="text-zinc-400 text-xs sm:text-sm mb-6">
          Cap of five lifts for today. Finish them, then load more.
        </p>

        <div className="bg-[#18181b] border border-zinc-800/80 rounded-xl flex flex-wrap justify-between gap-4 px-5 sm:px-8 py-5 sm:py-6 mb-8">
          <div>
            <p className="text-zinc-500 text-xs mb-1">Exercises</p>
            <p className="text-xl sm:text-2xl font-black text-[#b6fd00]">{plan.length}</p>
          </div>
          <div>
            <p className="text-zinc-500 text-xs mb-1">Minutes</p>
            <p className="text-xl sm:text-2xl font-black">{totalMinutes}</p>
          </div>
          <div>
            <p className="text-zinc-500 text-xs mb-1">Calories</p>
            <p className="text-xl sm:text-2xl font-black">{totalCalories}</p>
          </div>
        </div>

        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
          <div className="flex bg-[#18181b] border border-zinc-800 rounded-full p-1 w-fit">
            <button
        ...
        {sortedList.length === 0 ? (
          <div className="border border-dashed border-zinc-800 rounded-xl min-h-[300px] flex items-center justify-center p-6 sm:p-8">
            <div className="text-center">
              <h3 className="font-black uppercase text-base sm:text-lg mb-2">Nothing here yet</h3>
          ...
          <div className="flex flex-col gap-4">
            {sortedList.map((workout) => {
              ...
              return (
                <div
                  key={workout.id}
                  className="bg-[#18181b] border border-zinc-800 rounded-xl p-4 flex flex-col sm:flex-row sm:items-center gap-4"
                >
